    ...
    <nav className="bg-gradient-to-r from-pink-600 to-rose-500 p-4 shadow-md relative z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-8 text-white font-medium">
          ...
          <Link href="/about-us" className="hover:text-pink-200 transition">
            About
          </Link>
          <Link href="/services" className="hover:text-pink-200 transition">
            Services
          </Link>
          <Link href="/contact-us" className="hover:text-pink-200 transition">
            Contact
          </Link>
          <Link href="/privacy-policy" className="hover:text-pink-200 transition">
            Privacy
          </Link>
          <Link href="/terms-and-conditions" className="hover:text-pink-200 transition">
            Terms
          </Link>
      ...
      >
        <div className="flex flex-col space-y-4 bg-gradient-to-r from-pink-600 to-rose-500 p-4">
          ...
          <Link href="/about-us" className="text-white hover:text-pink-200 transition">
            About
          </Link>
          <Link href="/services" className="text-white hover:text-pink-200 transition">
            Services
          </Link>
          <Link href="/contact-us" className="text-white hover:text-pink-200 transition">
            Contact
          </Link>
          <Link href="/privacy-policy" className="text-white hover:text-pink-200 transition">
            Privacy Policy
          </Link>
          <Link href="/terms-and-conditions" className="text-white hover:text-pink-200 transition">
            Terms
          </Link>
          <Link href="/login" className="text-white hover:text-pink-200 transition">
            Login
          </Link>
